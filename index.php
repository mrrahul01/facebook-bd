...
<html>
<head>
	<title> Facebook BD</title>
    <link rel="icon" href="fb_files/fb_title_icon/Faceback.ico" type="image/gif" sizes="16x16">
<?php	
include("fb_files/fb_index_file/fb_background_file/index_background.php");
?>
<!--	<link rel="icon" href="fb_files/fb_title_icon/Faceback.png" type="image/gif" sizes="16x16">-->
