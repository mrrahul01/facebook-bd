...
<body>
	...
	<!--text: faceback -->
	<div style="position:absolute;left:13.5%; top:3.3%; font-size:45; font-weight:900; color:#FFFFFF; font-weight:bold;"> <font face="myFbFont">  Facebook BD </font> </div>
	<!--body background-->
    ...
    <div style="position:absolute;left:5%;top:105%;"><font face="myFbFont"> Developer: <span style=" color:#3B5998;" onMouseOver="open_developer_details()" onMouseOut="close_developer_details()" id="my_name"> <a href="https://www.facebook.com/rahul.khan.2095"> Md.Ruhul khan  </a></span> </font> </div>
